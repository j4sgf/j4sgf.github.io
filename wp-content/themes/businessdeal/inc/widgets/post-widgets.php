 ...
 */
 ...
 class BusinessDeal_posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget-latest-posts', 'description' => esc_html__( 'Display Latest Posts/ Category with small image and title. Suitable for Right and Left BusinessDeal Sidebar Section', 'businessdeal') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=esc_html__('T-Spiral: Latest Posts','businessdeal'), $widget_ops, $control_ops );
	}
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'no_of_posts' )); ?>"><?php esc_html_e( 'Number of posts:', 'businessdeal' ); ?></label> 
